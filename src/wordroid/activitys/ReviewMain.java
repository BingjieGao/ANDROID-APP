...
public class ReviewMain extends TabActivity implements TabHost.TabContentFactory{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		th.addTab(th.newTabSpec("shouldreview").setIndicator("My words",ReviewMain.this.getResources().getDrawable(R.drawable.should)).setContent(this));
		th.addTab(th.newTabSpec("alllists").setIndicator("All AWLs",ReviewMain.this.getResources().getDrawable(R.drawable.all)).setContent(this));
	...
	public View createTabContent(final String tag) {
		...
		if (tag.equals("shouldreview")){
			...
			lv.setOnItemLongClickListener(new OnItemLongClickListener(){
				...
				public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
		            ...
		            .setTitle("OPERATION")
		            .setItems(new String[]{"TAG TO HAVE BEEN REVIEWED"}, new DialogInterface.OnClickListener(){
			...
			lv.setOnItemClickListener(new OnItemClickListener(){
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					if(wordlist.get(arg2).getLearned().equals("0")){
			            ...
			            .setIcon(R.drawable.dialog_icon)
			            .setTitle("REMINDER")
			            .setMessage("AWL (LIST-"+(arg2+1)+")HAS NOT BEEN LEARNED£¬WANT TO START NOW£¿")
			            ...
			            .setIcon(R.drawable.dialog_icon)
			            .setTitle("REMIND")
			            .setMessage("AWL (LIST-"+(arg2+1)+")DOES NOT NEED TO LEARN NOW£¬INSIST ON LEARNING£¿")
			            .setPositiveButton("YES", new DialogInterface.OnClickListener() {
			                public void onClick(DialogInterface dialog, int whichButton) {
			                    /* User clicked OK so do some stuff */
								startReview(arg2+1,2);
		...
		if (tag.equals("plan")){
		    ...
		    minusbutton.setText("PREVIOUS WEEK");
		...
		if (tag.equals("shouldreview")){
			...
			for (int i=0;i<wordlist.size();i++){
				if (wordlist.get(i).getShouldReview().equals("1")){
					...
					map.put("times", "REVIEWED TIMES£º"+wordlist.get(i).getReview_times());
					map.put("lasttime", "PREVIOUS REVIEW TIME£º"+wordlist.get(i).getReviewTime());
