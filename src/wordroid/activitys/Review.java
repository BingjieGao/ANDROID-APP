...
public class Review extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setTitle("REVIEWEDLIST-"+listnum);
	...
	private void UpdateView() {
        ...
        nextone.setVisibility(View.GONE);}
            ...
            .setMessage("You can check your review time in review plan")
	...
	public void onClick(View v) {
		...
		if (v==add){
			...
			if (attention.size()==0){
				...
				Toast.makeText(Review.this, "Your words has been added successfully", Toast.LENGTH_SHORT).show();
			}
			else Toast.makeText(Review.this, "You already have this word in your list！", Toast.LENGTH_SHORT).show();
		}
	}
	@Override
