...
public class ImportBook extends ListActivity {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) { 
                ...
                default: {
                	...
                	data.DeleteBook();
                	DataAccess.bookID="";
                	Toast.makeText(ImportBook.this, "Fail to import the library", Toast.LENGTH_LONG)
        			.show();
                    break;
                    }
	...
	protected void onListItemClick(ListView l, View v, final int position, long id) {
		...
		dialog.setTitle("Import Library");
		...
		filename.setText("´Ê¿âÎÄ¼þ£º"+fileNames[position]);
		...
		confirm.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
						if (newname.getText().toString().equals("")){
							dialog.cancel();
							Toast.makeText(ImportBook.this, "The name cannot be empty", Toast.LENGTH_LONG)
							.show();
						}
				try{
					...
					dialog.cancel();
					Toast.makeText(ImportBook.this, "Sorry!Pleas enter an integer!", Toast.LENGTH_LONG)
					.show();
				}
				dialog.cancel();
				...
				myDialog = new ProgressDialog(ImportBook.this);
				 myDialog.setTitle("Import Library");
				 myDialog.setMessage("Please Wait a moment");
				 myDialog.setCancelable(false);
                myDialog.setButton("Cancel", new DialogInterface.OnClickListener() {
