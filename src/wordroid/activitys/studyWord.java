...
public class studyWord extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		listnum=name;
		this.setTitle("LEARNINGLIST-"+name);
	...
	public void onClick(View v) {
		...
		if (v==nextone){
			...
			if (attention.size()==0){
				...
				Toast.makeText(studyWord.this, "Your words has been added successfully!", Toast.LENGTH_SHORT).show();
			}
			else Toast.makeText(studyWord.this, "You already have this word in your list!", Toast.LENGTH_SHORT).show();
		...
		// TODO Auto-generated method stub
		 if (keyCode == KeyEvent.KEYCODE_BACK) {
			 Dialog dialog = new AlertDialog.Builder(this)
	            ...
	            .setTitle("UNFINISHED LEARNING")
	            .setMessage("Are you sure that you want to stop learning?")
	...
	private void UpdateView() {
		...
		if (currentnum<numoflist){
			...
			info.setText(list.get(currentnum).getPhonetic_alphabet()+"\n"+list.get(currentnum).getMeanning());
	            ...
	            .setMessage("YOU CAN REVIEW THIS CHAPTER ACCORDIND TO THE REVIEW PLAN")
	            .setPositiveButton("YES", new DialogInterface.OnClickListener() {
	                public void onClick(DialogInterface dialog, int whichButton) {
	                    /* User clicked OK so do some stuff */
	                	tts.shutdown();
